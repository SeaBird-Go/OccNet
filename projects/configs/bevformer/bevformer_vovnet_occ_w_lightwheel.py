...
_pos_dim_ = _dim_//2
_ffn_dim_ = _dim_*2
_out_features = ['stage2', 'stage3', 'stage4', 'stage5']
_num_levels_ = len(_out_features)
...
train_pipeline = [
    ...
    dict(type='DefaultFormatBundle3D', class_names=class_names, with_gt=False),
...
load_from = 'ckpts/dd3d_det_final.pth' # down load from https://drive.google.com/drive/folders/1h5bDg7Oh9hKvkFL-dRhu5-ahrEp2lRNN
log_config = dict(
    interval=50,
    hooks=[
